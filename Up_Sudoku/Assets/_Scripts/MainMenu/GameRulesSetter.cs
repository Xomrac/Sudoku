...
namespace MainMenu
{
    ...
    {
        [SerializeField] private GameRules defaultSettings;
        ...
        private void SetupElements()
        {
            ...
            {
                GameData.gameRules = new GameRules(defaultSettings.GameMode, defaultSettings.BlankCells, defaultSettings.MaxErrors, defaultSettings.MaxHints);
                GameStarted?.Invoke();
            });
